...
class UpdateDewormingServiceTest {
    ...
    void shouldUpdateDeworming() {
        ...
        var command = new UpdateDewormingUseCase.UpdateDewormingCommand(
                deworming.getId(),
                LocalDate.of(2026, 3, 5),
                new DrugName("Drontal"),
                new DrugDose("2 tablets (3mg)")
        );
    ...
    void shouldThrowWhenDewormingNotFound() {
        // Given
        var command = new UpdateDewormingUseCase.UpdateDewormingCommand(
                DewormingId.of("b3acd7d5-396a-44ce-880d-620aa1a92e3c"),
                LocalDate.now(),
                new DrugName("Not Found"),
                new DrugDose("Not Found")
        );
