...
class EmailTest {
    ...
    class Creation {
        ...
        void shouldCreateEmail() {
            var email = new com.petmanagement.owners.domain.model.valueobject.Email("jane.doe@example.com");
            assertEquals("jane.doe@example.com", email.value());
        }

        @Test
        void shouldCreateEmailWithPlusSign() {
            var email = new com.petmanagement.owners.domain.model.valueobject.Email("user+tag@example.com");
            assertEquals("user+tag@example.com", email.value());
        }

        @Test
        void shouldCreateEmailWithDotsInLocalPart() {
            var email = new com.petmanagement.owners.domain.model.valueobject.Email("john.q.doe@example.com");
            assertEquals("john.q.doe@example.com", email.value());
        }

        @Test
        void shouldCreateEmailWithSubdomain() {
            var email = new com.petmanagement.owners.domain.model.valueobject.Email("user@mail.example.com");
            assertEquals("user@mail.example.com", email.value());
        }

        @Test
        void shouldCreateEmailWithCountryCodeTLD() {
            var email = new com.petmanagement.owners.domain.model.valueobject.Email("user@example.co.uk");
            assertEquals("user@example.co.uk", email.value());
        }

        @Test
        void shouldCreateEmailWithDashInDomain() {
            var email = new com.petmanagement.owners.domain.model.valueobject.Email("user@my-domain.com");
    ...
    class Validation {
        ...
        void shouldThrowWhenValueIsNull() {
            assertThrows(NullPointerException.class, () -> new com.petmanagement.owners.domain.model.valueobject.Email(null));
        }

        @Test
        void shouldThrowWhenValueIsEmpty() {
            assertThrows(IllegalArgumentException.class, () -> new com.petmanagement.owners.domain.model.valueobject.Email(""));
        }
        ...
        void shouldThrowWhenMalformed(String email) {
            assertThrows(IllegalArgumentException.class, () -> new com.petmanagement.owners.domain.model.valueobject.Email(email));
        }
